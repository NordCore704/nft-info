...
const HorizontalTextTwo = ({ timeline }) => {
  ...
  return (
    <div className="border border-black w-full h-10 absolute bottom-8 bg-green-500 -skew-y-12 sm:-skew-y-6 md:-skew-y-6 lg:-skew-y-6 text-center flex gap-2 items-center justify-center overflow-hidden opacity-0 z-10" ref={mainRef}>
