...
const CategoriesSearch = () => {
  ...
  return (
    <div className='flex gap-3 flex-col md:flex-row-reverse lg:flex-row-reverse items-center justify-center my-10 p-5' ref={ref}>
        ...
        <motion.p className='capitalize font-semibold text-4xl text-center ' animate={animation} initial='hidden' variants={scrollPopVariant}>Search According To preferences and Categories</motion.p>
